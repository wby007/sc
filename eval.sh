...
#评估命令有效
#python evaluate.py NoBRS --datasets GrabCut --checkpoint outputs\plainvit_base448_graco\006\checkpoints\000.pth --lora_checkpoint weights\graco\GraCo_base_lora.pth --graco
python evaluate.py NoBRS --datasets=GrabCut --checkpoint=outputs/plainvit_base448_graco/002/checkpoints/000.pth --lora_checkpoint weights/graco/GraCo_base_lora.pth --graco
python evaluate.py NoBRS --datasets=GrabCut --checkpoint=weights/simpleclick/sbd_vit_base.pth --lora_checkpoint weights/graco/GraCo_base_lora.pth --graco
python evaluate.py NoBRS --datasets GrabCut --checkpoint weights/simpleclick/sbd_vit_large.pth --lora_checkpoint weights/graco/GraCo_large_lora.pth --graco
python evaluate.py NoBRS --datasets GrabCut,Berkeley,SBD,DAVIS,PascalVOC,ssTEM,BraTS,OAIZIB --checkpoint weights/simpleclick/sbd_vit_large.pth --lora_checkpoint weights/graco/GraCo_large_lora.pth --graco
